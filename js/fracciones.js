...
function dibujarPastel(){
    ...
    //     "C++":{valor:30,color:"Cyan"}
    // }
    let x=parseInt(document.getElementById("reprenumerador").value)
    let y=parseInt(document.getElementById("repredenominador").value)
    var valores={
        // "Access":{valor:10,color:"blue"},
        // "PHP":{valor:20,color:"red"}

        "parte tomada(numerador)":{valor:x,color:"blue"},
        "parte restante":{valor:y,color:"red"}
    }
